...
int i2c3_master_fputs(const char *data, int len, char *address, int addlen){return 1;}
int i2c3_master_fgets(char *data, int len, char *address, int addlen){return 1;}