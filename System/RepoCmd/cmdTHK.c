...
int thk_executeBeforeFlight(void *param){
    ...
    printf("****************************************************\r\n");
    printf("thk_executeBeforeFlight has finalized its settings\r\n");
    printf("To keep first-flight configuration the systems \r\n");
    printf("MUST be disconnected. Please do this BEFORE restart\r\n");
    printf("****************************************************\r\n");

    int i;
    for(i=10;i>=1;i--){
        __delay_ms(1000);
        printf("%d seconds before restart..\r\n", i);
    }
